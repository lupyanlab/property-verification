source("models/cue_first/amount_of_knowledge__accuracy_for_plot.R")
...
imagery_range <- range(cue_first$imagery_mean)
...
facts_range <- range(cue_first$facts_mean)
...
if (SAVE_AS == TRUE) {
  png("plots/cue_first/amount_of_knowledge__accuracy_imagery.png",
      width = 6, height = 6, units = "in", res = 200)
  grid.draw(imagery_gt)
  dev.off()
  
  png("plots/cue_first/amount_of_knowledge__accuracy_encyclopedic.png",
      width = 6, height = 6, units = "in", res = 200)
  grid.draw(factual_gt)
  dev.off()
  
  png("plots/cue_first/amount_of_knowledge__accuracy.png",
